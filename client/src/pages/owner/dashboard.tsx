...
const PREMADE_CATEGORIES = [
  ...
  { name: "Men's Hair", description: "Haircuts, fades, and styling for men", icon: "Scissors", color: "#3B82F6" },
  { name: "Men's Skincare", description: "Facials, cleanups, and skin treatments for men", icon: "Sparkles", color: "#10B981" },
  { name: "Men's Massage", description: "Relaxation and therapeutic massage for men", icon: "Star", color: "#8B5CF6" },
  { name: "Men's Waxing", description: "Waxing services for men", icon: "Scissors", color: "#10B981" },
  { name: "Men's Nail Care", description: "Manicure and pedicure for men", icon: "Palette", color: "#F59E0B" },
  { name: "Women's Hair", description: "Haircuts, coloring, and styling for women", icon: "Scissors", color: "#EC4899" },
  { name: "Women's Facial & Skin", description: "Facials and skin treatments for women", icon: "Sparkles", color: "#10B981" },
  { name: "Women's Nail Services", description: "Nail art, extensions, and polish for women", icon: "Palette", color: "#F59E0B" },
  { name: "Women's Makeup", description: "Party, HD, airbrush and festive makeup", icon: "Palette", color: "#EC4899" },
  { name: "Women's Spa & Massage", description: "Spa, body massage and relaxation for women", icon: "Star", color: "#8B5CF6" },

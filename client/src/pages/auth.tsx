      ...
      if (activeTab === "signin") {
        ...
        if (response.ok) {
          ...
          localStorage.setItem(
            `sanwar_onboarding_${userType}_fresh_signup`,
            "true",
          );
          ...
          <CardHeader className="text-center pb-6">
            ...
            <div className="mb-4">
              <Link
                ...
                data-testid="link-back-home-card"
              >
          ...
          <CardContent className="space-y-6">
            ...
            {activeTab === "signup" && (
              <div>
                ...
                <RadioGroup
                  ...
                  onValueChange={(value) =>
                    setUserType(
                      value as "customer" | "salon_owner" | "brand_owner",
                    )
                  }
                  className="space-y-2"
                >
            ...
            <div className="space-y-4">
              ...
              <Button
                ...
                data-testid={
                  activeTab === "signin" ? "button-signin" : "button-signup"
                }
              >
                {loading ? (
                  <>
